...
public class MainProgram {
    public static void main(String[] args) {
        ...
        while (running){
            System.out.print("Enter your query (f/t/m/b/c): ");
            ...
            switch (command) {
                ...
                case "t":// Show ticket details
                    System.out.println("___ Tickets List ___");
                ...
                case "m"://Show member info
                    System.out.println("___ Members List___");
        ...
        // Send an auto notice to member
        private static void noticeLetter(String ticketName){
