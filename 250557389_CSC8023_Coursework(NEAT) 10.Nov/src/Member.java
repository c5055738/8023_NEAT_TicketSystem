...
public class Member implements Comparable<Member> {
    ...
    public void memberInfo(){
        ...
        System.out.println(firstName + " " + lastName + " bought " + purchasedTickets.size() + " types of tickets. Total price: $" + String.format("%.2f", totalPrice));
    ...
    public String toString() {
        return firstName + " " + lastName + " bought " + purchasedTickets.size() + " types of tickets";
    }
